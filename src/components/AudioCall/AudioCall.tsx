...
import { JoinRoomMutation, roomConnectingToOtherMutation } from '../../graphql/mutations';
...
const AudioCall = ({ navigation, colors, isDark, }: { route: any; navigation: any; colors: any; isDark: boolean; }) => {
  ...
  async function joinRoom2(userToken: string) {
    await room_Connecting_To_Other({
      ...
      // console.log("CAll 1")
      // console.log(res.data.connectingRoom.firstParticipantToken)
  ...
  async function joinRoom() {
    ...
    await Join_Room_Mutation({
      ...
      .then(async (res: any) => {
        ...
        //   variables: {
        //     joinRoomArgs: {
        //       username: res.data.joinRoom.firstParticipantToken,
        //     },
        //   },
        // })
        //   .then(async (res: any) => {
